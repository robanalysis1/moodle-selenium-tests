...
/**
 * The page object model for the Admin tool to upgrade old assignemnts to the new assignment module.
 * @author Tim Barker 
 * @see <a href="http://www.gnu.org/copyleft/gpl.html">License: GNU GPL v3 or later</a>
 */
public class AssignmentAdminUpgradeAssignments {
	//Internationalization file location
	public static String data = "properties/data/static/assignmentAdminUpgradeAssignments.properties";
 ...
 */
	public AssignmentAdminUpgradeAssignments(RemoteWebDriver driver) {
		this.driver = driver;
		this.loadObjectData();
	}
/**
 * Loads data for the page object from the internationalization layer /properties/data/static/assignmentAdminUpgradeAssignments.properties
