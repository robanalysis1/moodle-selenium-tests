...
/**
 * The page object model for managing the assignment feedback plugins.
 * @author Tim Barker 
 * @see <a href="http://www.gnu.org/copyleft/gpl.html">License: GNU GPL v3 or later</a>
 */
public class AssignmentPluginManageFeedback {
	//Internationalization file location
	public static String data = "properties/data/static/assignmentPluginManageFeedback.properties";
 ...
 */
	public AssignmentPluginManageFeedback(RemoteWebDriver driver) {
		this.driver = driver;
		this.loadObjectData();
	}
/**
 * Loads data for the page object from the internationalization layer /properties/data/static/assignmentPluginManageFeedback.properties
